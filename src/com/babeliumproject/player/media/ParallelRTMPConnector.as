...
package com.babeliumproject.player.media
{
	...
	public class ParallelRTMPConnector
	{
		...
		protected static const log:ILogger=getLogger(ParallelRTMPConnector);
		...
		public function ParallelRTMPConnector(url:String, onSuccess:Function, onFailure:Function)
		{
			_url=url;
